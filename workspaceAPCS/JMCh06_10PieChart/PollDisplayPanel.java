...
public class PollDisplayPanel extends JPanel
{
    ...
    private void drawPieChart( Graphics g, int x, int y, int r )
    {
        ...
        {
            int degrees;
            g.setColor( Color.RED ); // RGB YAAHHH
            ...
            fromDegree += degrees; // increment fromDegrees to start from end of
    ...
    {
        // Guarantee that the result is rounded up even after truncation by the
        // int typecast.
