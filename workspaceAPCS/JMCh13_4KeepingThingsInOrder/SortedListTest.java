...
public class SortedListTest
{
    public static void main( String[] args )
    {
        ...
        System.out.println(
            "contains(\"Amy\") = " + names1.contains( "amy" ) + 
            " indexOf(\"Amy\") = " + names1.indexOf( "amy" ) );
        System.out.println(
            "contains(\"Ben\") = " + names1.contains( "ben" ) + 
            " indexOf(\"Ben\") = " + names1.indexOf( "ben" ) );
        System.out.println(
            "contains(\"Dan\") = " + names1.contains( "dan" ) + 
...
// names1 + names2 = [Aaron, Amy, Barb, Ben, Claire, Connie, Dan, Debby, Evan,
// Eve, Fiona, Frank, Gina]
// [Aaron, Amy, Barb, Ben, Claire, Connie, Dan, Debby, Evan, Eve, Fiona, Frank,
// Gina]
