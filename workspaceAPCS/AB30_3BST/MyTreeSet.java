...
public class MyTreeSet<E>
{
    ...
    private int countLeaves( TreeNode<E> root )
    {
        ...
        int leftCount = countNodesHelper( root.getLeft() );
        int rightCount = countNodesHelper( root.getRight() );
    ...
    private int width( TreeNode<E> root )
    {
        ...
        return max( width( root.getLeft() ),
            max( width( root.getRight() ), 1 + height( root.getLeft() ) + height( root.getRight() ) ) );
    }
    ...
    private int[] nodeCounts( TreeNode<E> root )
    {
        ...
        result[1] = Math.abs( countNodesHelper( root.getRight() ) - countNodesHelper( root.getLeft() ) );
        return result;
    }
